...
// prettier-ignore
{
    ...
    BYTE_INFO.set(/^.{8}667479704D534E56/i,               'mp4'); // mp4
    BYTE_INFO.set(/^.{8}6674797069736F6D/i,               'mp4'); // mp4
    BYTE_INFO.set(/^.{8}667479706d703432/i,               'mp4'); // m4v
    BYTE_INFO.set(/^.{8}6674797071742020/i,               'mp4'); // mov
